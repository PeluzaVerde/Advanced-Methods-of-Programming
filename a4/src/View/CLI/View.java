                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                ...
                                                new CompoundStatement(
                                                        new PrintStatement(new VariableExpression("v")),
                                                        new PrintStatement(new HeapReadExpression(new VariableExpression("a")))))))));
//        Ref int a; Ref int b; int v; new(a,0); new(b,0);wh(a,1); wh(b,2);v=(rh(a)<rh(b))?100:200;print(v);v= ((rh(b)-2)>rh(a))?100:200;print(v);The final Out should be {100,200}


        IStatement s11= new CompoundStatement(
                new VarDeclarationStatement("a", new RefType(new IntType())),
                new CompoundStatement( new VarDeclarationStatement("b", new RefType(new IntType())),
                        new CompoundStatement(new VarDeclarationStatement("v", new IntType()),
                                                ...
                                                new CompoundStatement(
                                                        new HeapWriteStatement("a", new ValueExpression(new IntValue(1))),
                                                                new CompoundStatement(
                                                                        ...
                                                                        new CompoundStatement(
                                                                                new ConditionalAssignmentStatement("v", new RelationalExpression(new HeapReadExpression(new VariableExpression("a")),
                                                                                ...
                                                                                new CompoundStatement( new PrintStatement(new VariableExpression("v")),
                                                                                        new CompoundStatement(
                                                                                        new ConditionalAssignmentStatement("v", new RelationalExpression(new ArithmeticExpression(new HeapReadExpression(new VariableExpression("b")),
        ...
        IStatement s12 = new CompoundStatement(
                ...
                new CompoundStatement(
                        ...
                        new CompoundStatement(
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                new HeapNewStatement("v1", new ValueExpression(new IntValue(2))),
                                                new CompoundStatement(
                                                        new HeapNewStatement("v2", new ValueExpression(new IntValue(3))),
                                                        new CompoundStatement(
                                                                new HeapNewStatement("v3", new ValueExpression(new IntValue(4))),
                                                                new CompoundStatement(
        ...
        c1 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile1", false);
        c2 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile2", false);
        c3 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile3", false);
        c4 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile4", false);
        c5 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile5", false);
        c6 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile6", false);
        c7 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile7", false);
        c8 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile8", false);
        c9 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile9", false);
        c10 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile10", true);
        c11 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile11", false);
        //c12 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile12", false);
        c12 = new Controller("C:\\Users\\HP\\IdeaProjects\\a4\\logFile12", false);
        ...
        r11 = new RunCommand(s11, "11", "Ref int a; Ref int b; int v; new(a,0); new(b,0);wh(a,1); wh(b,2);v=(rh(a)<rh(b))?100:200;print(v);v= ((rh(b)-2)>rh(a))?100:200;print(v)\n", c11);

        r12 = new RunCommand(s12, "12", "latch example", c12);
        menu.addCommand(r1);
        menu.addCommand(r2);
        menu.addCommand(r3);
        menu.addCommand(r4);
