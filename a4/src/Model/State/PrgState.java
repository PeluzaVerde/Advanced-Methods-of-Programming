...
public class PrgState {
    ...
    public PrgState(IStack<IStatement> executionStack, IDictionary<String, IValue> symTable, IList<String> out, IDictionary<StringValue, BufferedReader> fileTable, IHeap heap, MyILatchTable latchTable, Integer id) {
    ...
    public String latchTableToString() throws EvaluationException {
    ...
    public String toString() {
        return String.format("ID: %d\n\n~ EXECUTION STACK ~\n%s\n~ SYMBOL TABLE ~\n%s\n~ OUTPUT ~\n%s\n~ FILE TABLE ~\n%s\n~ HEAP ~\n%s\n~ latch TABLE ~\n%s\n", id, executionStackToString(), symTableToString(), outToString(), fileTableToString(), heapToString(), latchTable.toString());
    }
